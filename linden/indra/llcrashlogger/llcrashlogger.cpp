...
void LLCrashLogger::gatherFiles()
{
	...
	*/
	...
	{		
		...
		mFileMap["RainbowViewerLog"] = mDebugLog["RVLog"].asString();
	...
	else
	{
		...
		mFileMap["SettingsXml"] = gDirUtilp->getExpandedFilename(LL_PATH_USER_SETTINGS,"settings_1.19.xml");
	}
...
bool LLCrashLogger::init()
{
	...
	{
		llinfos << "Previous execution did not remove RainbowViewer.exec_marker" << llendl;
	...
	if( gDirUtilp )
	{
		LLString marker_file = gDirUtilp->getExpandedFilename(LL_PATH_LOGS,"RainbowViewer.exec_marker");
