...
BOOL	LLFloaterTools::postBuild()
{
	...
	mSliderDozerForce = LLUICtrlFactory::getSliderBarByName(this, "slider force");
	childSetCommitCallback("slider force",commit_slider_dozer_force,this);
	childSetValue( "slider force", gSavedSettings.getF32("LandBrushForce"));
...
void LLFloaterTools::updatePopup(LLCoordGL center, MASK mask)
{
	...
	if (mSliderDozerForce)
	{
		...
		childSetVisible("Force:", land_visible);
	}
...
{
	F32 dozer_force = (F32)ctrl->getValue().asReal();
