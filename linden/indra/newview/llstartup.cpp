...
//mk
	...
	if(STATE_LOGIN_PROCESS_RESPONSE == LLStartUp::getStartupState())
	{
		...
		if(successful_login)
		{
			...
			text = gUserAuthp->getResponse("agent_access_max");
			if (text)
			{
				// agent_access can be 'A', 'M', and 'PG'.
				gAgent.setMaturity(text[0]);
				gSavedSettings.setU32("PreferredMaturity", LLAgent::convertTextToMaturity(text[0]));
			}
...
//mk
		...
		// Send our preferred maturity (max possible).
		gAgent.sendMaturityPreferenceToServer(gSavedSettings.getU32("PreferredMaturity"));
...
void login_show()
{
	...
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_OSGRID].mLabel,		GRID_INFO_OSGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_DEEPGRID].mLabel,		GRID_INFO_DEEPGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_EMERALD].mLabel,		GRID_INFO_EMERALD );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_FRANCOGRID].mLabel,	GRID_INFO_FRANCOGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_MONDEDARWIN].mLabel,	GRID_INFO_MONDEDARWIN );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_EUGRID].mLabel,		GRID_INFO_EUGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_GIANTGRID].mLabel,		GRID_INFO_GIANTGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_NEWWORLD].mLabel,		GRID_INFO_NEWWORLD );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_3RDROCK].mLabel,		GRID_INFO_3RDROCK );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_LEGENDCITY].mLabel,	GRID_INFO_LEGENDCITY );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_UVATAR].mLabel,		GRID_INFO_UVATAR );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_GRIDSPLASH].mLabel,	GRID_INFO_GRIDSPLASH );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_WORLDSIMTERRA].mLabel,	GRID_INFO_WORLDSIMTERRA );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_CYBERLANDIA].mLabel,	GRID_INFO_CYBERLANDIA );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_TRIBALNET].mLabel,		GRID_INFO_TRIBALNET );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_METROPOLIS].mLabel,	GRID_INFO_METROPOLIS );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_AUGRID].mLabel,		GRID_INFO_AUGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_AVATARHANGOUT].mLabel,	GRID_INFO_AVATARHANGOUT );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_GERMANGRID].mLabel,	GRID_INFO_GERMANGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_DGPGRID].mLabel,		GRID_INFO_DGPGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_LIFESIM].mLabel,		GRID_INFO_LIFESIM );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_FANTASYWORLD].mLabel,	GRID_INFO_FANTASYWORLD );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_RMHDESIGN].mLabel,		GRID_INFO_RMHDESIGN );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_REACTIONGRID].mLabel,	GRID_INFO_REACTIONGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_FUTURELIFE].mLabel,	GRID_INFO_FUTURELIFE );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_PSEUDOSPACE].mLabel,	GRID_INFO_PSEUDOSPACE );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_YOURGRID].mLabel,		GRID_INFO_YOURGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_MYOPENGRID].mLabel,	GRID_INFO_MYOPENGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_PHOENIXSIM].mLabel,	GRID_INFO_PHOENIXSIM );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_VIRTUALSIMS].mLabel,	GRID_INFO_VIRTUALSIMS );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_GRID4US].mLabel,		GRID_INFO_GRID4US );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_OPENKANSAI].mLabel,	GRID_INFO_OPENKANSAI );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_SCHWEIZ].mLabel,		GRID_INFO_SCHWEIZ );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_DREAMLAND].mLabel,		GRID_INFO_DREAMLAND );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_ALTLIFE].mLabel,		GRID_INFO_ALTLIFE );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_SCIENCESIM].mLabel,	GRID_INFO_SCIENCESIM );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_UNICA].mLabel,			GRID_INFO_UNICA );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_GORGRID].mLabel,		GRID_INFO_GORGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_CUONGRID].mLabel,		GRID_INFO_CUONGRID );
	LLPanelLogin::addServer( gGridInfo[GRID_INFO_ARTGRID].mLabel,		GRID_INFO_ARTGRID );
