			  ...
			  DRAG_ON_TOP, MINIMIZE_YES, CLOSE_YES)
{
	...
	gUICtrlFactory->buildFloater(this,"floater_bulk_perms.xml");
	...
	processObject=LLUICtrlFactory::getCheckBoxByName(this, "objects")->get();
	processScript=LLUICtrlFactory::getCheckBoxByName(this, "scripts")->get();
	processTexture=LLUICtrlFactory::getCheckBoxByName(this, "textures")->get();
	processSound=LLUICtrlFactory::getCheckBoxByName(this, "sounds")->get();
	processAnimation=LLUICtrlFactory::getCheckBoxByName(this, "animations")->get();
	processNotecard=LLUICtrlFactory::getCheckBoxByName(this, "notecards")->get();
	processGesture=LLUICtrlFactory::getCheckBoxByName(this, "gestures")->get();
	processClothing=LLUICtrlFactory::getCheckBoxByName(this, "clothing")->get();
	processBodypart=LLUICtrlFactory::getCheckBoxByName(this, "bodyparts")->get();
	processLandmark=LLUICtrlFactory::getCheckBoxByName(this, "landmarks")->get();
	parent=LLUICtrlFactory::getCheckBoxByName(this, "Parent")->get();
...
void LLFloaterBulkPermission::InvSelection(LLUICtrl* ctrl, void* data)
{
	...
	self->processObject=LLUICtrlFactory::getCheckBoxByName(self, "objects")->get();
	self->processScript=LLUICtrlFactory::getCheckBoxByName(self, "scripts")->get();
	self->processTexture=LLUICtrlFactory::getCheckBoxByName(self, "textures")->get();
	self->processSound=LLUICtrlFactory::getCheckBoxByName(self, "sounds")->get();
	self->processAnimation=LLUICtrlFactory::getCheckBoxByName(self, "animations")->get();
	self->processNotecard=LLUICtrlFactory::getCheckBoxByName(self, "notecards")->get();
	self->processGesture=LLUICtrlFactory::getCheckBoxByName(self, "gestures")->get();
	self->processClothing=LLUICtrlFactory::getCheckBoxByName(self, "clothing")->get();
	self->processBodypart=LLUICtrlFactory::getCheckBoxByName(self, "bodyparts")->get();
	self->processLandmark=LLUICtrlFactory::getCheckBoxByName(self, "landmarks")->get();
...
{
	LLFloaterBulkPermission* self = (LLFloaterBulkPermission*)data;
	self->parent=LLUICtrlFactory::getCheckBoxByName(self, "Parent")->get();
}
...
{
	LLFloaterBulkPermission* self = (LLFloaterBulkPermission*)data;
	self->recurse=LLUICtrlFactory::getCheckBoxByName(self, "Recurse")->get();
}
...
{
	LLFloaterBulkPermission* self = (LLFloaterBulkPermission*)data;
	LLCheckBoxCtrl* CheckModify = LLUICtrlFactory::getCheckBoxByName(self, "Modify");
	LLCheckBoxCtrl* CheckCopy = LLUICtrlFactory::getCheckBoxByName(self, "Copy");
	LLCheckBoxCtrl* CheckTrans = LLUICtrlFactory::getCheckBoxByName(self, "Trans");
