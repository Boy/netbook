...
//MK
		if (!RRenabled ||
			(attachment->getObject()->getRootEdit() &&
			 ...
			 !gAgent.mRRInterface.contains("detach:"+gAgent.mRRInterface.findAttachmentNameFromPoint(attachment)))
		{
...
//mk
	...
	{
//MK
		if (!RRenabled || !attachment ||
			(attachment && !gAgent.mRRInterface.contains("detach:"+gAgent.mRRInterface.findAttachmentNameFromPoint(attachment))))
		{
//mk
...
//MK
				if (!RRenabled || 
					...
					!gAgent.mRRInterface.contains("detach:"+avatarp->getAttachedPointName(mUUID))))
				{
					items.push_back("Detach From Yourself");
				}
				else
				{
					disabled_items.push_back("Detach From Yourself");
				}
//mk
			}
			else
...
//MK
				...
				{
					disabled_items.push_back("Object Wear");
				}
//mk
