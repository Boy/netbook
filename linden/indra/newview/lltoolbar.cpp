...
#endif // LL_DARWIN
{
	...
	{
		gUICtrlFactory->buildPanel(this, "panel_toolbar2.xml");
	}
	else
	{
...
//MK
	if (RRenabled)
	{
		childSetEnabled("build_btn", gParcelMgr->agentCanBuild() && !gAgent.mRRInterface.mContainsRez && !gAgent.mRRInterface.mContainsEdit);
