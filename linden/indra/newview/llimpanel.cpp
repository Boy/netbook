...
void LLFloaterIMPanel::sendMsg()
{
	...
	LLWString::trim(text);
//MK
	if (RRenabled && gAgent.mRRInterface.contains ("sendim")) { // user is forbidden to send IMs
		if (!gAgent.mRRInterface.contains ("sendim:"+mOtherParticipantUUID.asString())) { // ... and the receiver is no exception
