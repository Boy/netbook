...
public:
	...
	static void		onSaveToDiskMenu(void* userdata);
	static void		onLoadFromDiskMenu(void* userdata);
	...
	static BOOL		enableSaveToDiskMenu(void* userdata);
	static BOOL		enableLoadFromDiskMenu(void* userdata);
